  ...
  module Rails
    module Generators
      ...
      module MultiselectInjections
        ...
        # ---- pre-extras scaffolds (before 0.7.0) -----------------------------------

        # Older scaffold output has no extras: hash to ride on, so it is
        # threaded through here — the header/keyword plus the two render
        # calls, anchored on text every scaffold emitted verbatim.
